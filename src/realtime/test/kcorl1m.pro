...
; 27 Mar 2015 [ALS] kcorl1m.pro: Remove the artificial occuling, 
;                   which effectively enlarges the occulted region 
;                   around sun center.
;-------------------------------------------------------------------------------
...
; keyword parameter.
;
; All Level 1 files (fits & gif) will be stored in the sub-directory 'levelo',
; under the date directory.
;------------------------------------------------------------------------------
;-

pro kcorl1m, date_str, list=list, base_dir=base_dir, append=append, $
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; GdT: cal_file and cal_dir are now keywords.

default, cal_dir,   '/hao/mlsodata1/Data/KCor/calib_files'

; default, cal_file,  '20150101_190612_kcor_cal_1.0ms.ncdf'
;
; New default calilbration file, starting on 10 March 2015,
; following color corrector lens changes by Dennis Gallagher.
...
;                year, ' ', month, ' ', day, ' ', hour, ' ', minute, ' ', second
   ...
   ;--- Currently processing all images in list.
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   ...
   ; GdT: use mask to build final image (to check pointing issues).
...
;                        ' calibration file:dark, opal, 4 pol.states'
   sxaddpar, newheader, 'L1SWID',   'kcorl1m.pro 27mar2015', $
                        ' Level 1 software'
...
PRINT,        '>>>>>>> End of kcorl1m <<<<<<<'
PRINTF, ULOG, '>>>>>>> End of kcorl1m <<<<<<<'
PRINTF, ULOG, '- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -'
