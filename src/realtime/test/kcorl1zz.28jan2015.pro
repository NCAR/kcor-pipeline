...
pro kcorl1zz, date_str, list=list, base_dir=base_dir
...
;cal_dir = '/hao/mlsodata1/Data/KCor/raw/20140620';
;calfile = '20140620-201604_cal.ncdf';

;caldir  = '/hao/mlsodata1/Data/KCor/raw/20131031';
;calfile = '20131031_cal_214306_kcor.ncdf')

;--- 2.5 msec data on Aug 29:
;cal_dir = '/hao/mlsodata1/Data/KCor/raw/20140829/'
...
calfile = '20140310_191609_kcor_cal_1.0ms.ncdf';
calfile = '20150101_190612_kcor_cal_1.0ms.ncdf'
...
;   write_gif, 'cam1_mk4u_annulus.gif', save
   ...
   center_info = kcor_find_image (cal_data(*, *, 0, 0), $
   ...
   center_info = kcor_find_image (cal_data(*, *, 1, 0), $
                                  radius_guess, /center_guess)
   ...
   sxaddpar, newheader, 'L1SWID',   'kcorl1zz.pro 28jan2015', $
...
;   window, 0, xs = 512, ys = 512, retain = 2
   ...
   xyouts, 507, 256, 'West', color = 255, $
           charsize = 1.0, alignment = 0.5, orientation = 90., /device
   xyouts, 4, 34, 'Level 1 data', color = 255, $
           charsize = 1.0, /device
...
PRINT,        '>>>>>>> End of kcorl1zz <<<<<<<'
PRINTF, ULOG, '>>>>>>> End of kcorl1zz <<<<<<<'
