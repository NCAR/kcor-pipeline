...
; initial guesses have been changed (values for camera 0 and 1 have opposite sign)
   ...
   PRINT, ' camera 0 guess ', a , a*!radeg , format='(a20, 4f10.5)'
  
   PRINTF, ULOG, 'sin2theta guuess coefficients for CAMERA 0 : ', a
...
!p.multi=[0,1,2]
   ...
   PRINT, ' camera 0 coeff ', a , a*!radeg , format='(a20, 4f10.5)'
...
!p.multi=[0,1,1]
   ...
   PRINT, ' camera 1 coeff ', a , a*!radeg , format='(a20, 4f10.5)'
...
;
   ...
   PRINTF, ULOG, 'shifted images to arry center and rotate N up'
...
;                        ' calibration file:dark, opal, 4 pol.states'
   sxaddpar, newheader, 'L1SWID',   'kcorl1g.pro 12jan2015', $
