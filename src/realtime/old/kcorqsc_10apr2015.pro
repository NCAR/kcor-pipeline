...
PRO kcorqsc, date, list=list, append=append, gif=gif
...
IF (np EQ 0) THEN $
BEGIN ;{
   PRINT, "kcorqsc, 'yyyymmdd', list='list'"
   RETURN
END   ;}
...
cal_dir   = '/hao/mlsodata1/Data/KCor/cal/'	; calibration base directory.
raw_dir   = '/hao/mlsodata1/Data/KCor/raw/'	; raw base directory.

date_dir  = raw_dir + date + '/'		; L0 fits files.
cdate_dir = cal_dir + date + '/'		; calibration date directory.
