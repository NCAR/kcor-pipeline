...
pro kcorl1go, date_str, list=list, base_dir=base_dir, append=append, $
...
default, cal_dir,   '/hao/mlsodata1/Data/KCor/calib_files'
 ...
 default, cal_file,  '20150315_202646_kcor_cal_1.0ms.ncdf'   ; use starting on March 10, 2015 following color corrector lens
 							     ; changes by Dennis G.
...
;                        ' calibration file:dark, opal, 4 pol.states'
   sxaddpar, newheader, 'L1SWID',   'kcorl1g.pro 18mar2015', $
                        ' Level 1 software'
