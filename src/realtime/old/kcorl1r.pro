...
;PRINT,        '--- kcorl1r ', date_str, ' --- ', current_time
;PRINT,        'l0_dir: ', l0_dir
;PRINT,        'l1_dir: ', l1_dir

PRINTF, ULOG, '--- kcorl1r ', date_str, ' --- ', current_time
...
;                        ' calibration file:dark, opal, 4 pol.states'
   ...
   sxaddpar, newheader, 'SGSRAZR',  struct.sgsrazr, $
                        ' [arcsec] SGS RA zeropoint offset', format = '(f9.3)'
   ...
   sxaddpar, newheader, 'SGSDECZR', struct.sgsdeczr, $ 
                        ' [arcsec] SGS DEC zeropoint offset', format = '(f9.3)'
