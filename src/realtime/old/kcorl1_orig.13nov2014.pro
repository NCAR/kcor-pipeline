...
; find_image         (tomczyk author, code is in: /acos/sw/idl/gen )
...
;  Used image distortion test results of Oct 30, 2013 generated by Steve 
;  bias = 0.002     
;  tv, bytscl(corona^0.8, min=-.05, max=0.15)      
;  mini= 0.00    
;  maxi= 0.08     
;------------------------------------------------------------------------------
; Program expects a list of L0 files called 'list' (unless list keyword exists).
;------------------------------------------------------------------------------
;-
...
;  IF (TYPE EQ 'science') THEN BEGIN
   ...
   ;    for each camera.
      ...
      center_info_gain = find_image (gain_alfred (*, *, b), chisq = chisq, $
                                     radius_guess = 175.0, drad = 50.0)
      center_info_img  = find_image (img (*, *, 0, b), chisq = chisq, $
                                     radius_guess = 175.0, drad = 50.0)
...
;   write_gif, '20140508_caldata12_20140508_175541cal_shiftedgain.gif', save
   ...
   center_info = find_image (cal_data (*, *, 0, 0), chisq = chisq, $
                             radius_guess = 175.0, drad = 50.0)
   ...
   PRINTF, ULOG, $
           ...
           center_info
   xctr0 = 511.5 + center_info (0)
   yctr0 = 511.5 + center_info (1)
   radius_1 = center_info (2)

   ;--- CAMERA 1:

   center_info = find_image (cal_data (*, *, 1, 0), chisq = chisq, $
                             radius_guess = 175.0, drad = 50.0)
   ...
   xctr1 = 511.5 + center_info (0)
   yctr1 = 511.5 + center_info (1)
...
;   END OF VIGNETTING FUNCTION 
   ...
   crop_img = rebin_img (128:640, 128:640)
