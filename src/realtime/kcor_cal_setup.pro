;+
;-------------------------------------------------------------------------------
; pro kcor_cal_setup, data, metadata, pixel, beam, parinfo, functargs
;-------------------------------------------------------------------------------
; :description:
; Creates the parinfo and functargs structs for mpfit.
;-------------------------------------------------------------------------------
; :params:
;
; data
...
; This is the same procedure as kcor_reduce_calibration_setup_lm.
...
; 18 parameters go into the model, but 7 are fixed,
; so there are 11 free parameters.
