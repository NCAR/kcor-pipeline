...
; Get product type from filename and skip inserting of non-pB;  Parse from header when new producttype keyword is added.
	...
	;TODO: Remove _test from table name
		db->execute, 'INSERT INTO mlso_sgs_test (date_obs, source, sgsdimv, sgsdims, sgssumv, sgsrav, sgsras, sgsrazr, sgsdecv, sgsdecs, sgsdeczr, sgsscint, sgssums, sgsloop) VALUES (''%s'', ''%s'', %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %d) ', $
				   date_obs, sgs_source, sgsdimv, sgsdims, sgssumv, sgsrav, sgsras, sgsrazr, sgsdecv, sgsdecs, sgsdeczr, sgsscint, sgssums, sgsloop, $
