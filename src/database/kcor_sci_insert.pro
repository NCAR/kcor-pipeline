...
pro kcor_sci_insert, date, files, $
  ...
  for f = 0L, n_elements(files) - 1L do begin
    ...
    if (~file_test(files[f])) then begin
      ...
      mg_log, 'inserting %s', file_basename(files[f]), name='kcor/eod', /info
    endelse
    ...
    annulus_half_width = run->epoch('synoptic_map_annulus_width') / 2.0

    r111 = kcor_annulus_gridmeans(image, 1.11, annulus_half_width, sun_pixels)
    r115 = kcor_annulus_gridmeans(image, 1.15, annulus_half_width, sun_pixels)
    r120 = kcor_annulus_gridmeans(image, 1.2, annulus_half_width, sun_pixels)
    r135 = kcor_annulus_gridmeans(image, 1.35, annulus_half_width, sun_pixels)
    r150 = kcor_annulus_gridmeans(image, 1.5, annulus_half_width, sun_pixels)
    r175 = kcor_annulus_gridmeans(image, 1.75, annulus_half_width, sun_pixels)
    r200 = kcor_annulus_gridmeans(image, 2.0, annulus_half_width, sun_pixels)
    r225 = kcor_annulus_gridmeans(image, 2.25, annulus_half_width, sun_pixels)
    r250 = kcor_annulus_gridmeans(image, 2.5, annulus_half_width, sun_pixels)
    ...
    enhanced_r111 = kcor_annulus_gridmeans(enhanced_image, 1.11, annulus_half_width, sun_pixels)
    enhanced_r115 = kcor_annulus_gridmeans(enhanced_image, 1.15, annulus_half_width, sun_pixels)
    enhanced_r120 = kcor_annulus_gridmeans(enhanced_image, 1.2, annulus_half_width, sun_pixels)
    enhanced_r135 = kcor_annulus_gridmeans(enhanced_image, 1.35, annulus_half_width, sun_pixels)
    enhanced_r150 = kcor_annulus_gridmeans(enhanced_image, 1.5, annulus_half_width, sun_pixels)
    enhanced_r175 = kcor_annulus_gridmeans(enhanced_image, 1.75, annulus_half_width, sun_pixels)
    enhanced_r200 = kcor_annulus_gridmeans(enhanced_image, 2.0, annulus_half_width, sun_pixels)
    enhanced_r225 = kcor_annulus_gridmeans(enhanced_image, 2.25, annulus_half_width, sun_pixels)
    enhanced_r250 = kcor_annulus_gridmeans(enhanced_image, 2.5, annulus_half_width, sun_pixels)
