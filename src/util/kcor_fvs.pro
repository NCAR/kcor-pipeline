...
;
; SYNTAX	kcor_fvs, 'list', cm='color.lut', /gif
;
...
;
;
; EXAMPLES	kcor_fvs, 'list'
;		kcor_fvs, 'list', /gif
;		kcor_fvs, 'list', cm='/home/stanger/color/bwcp'
;		kcor_fvs, 'list', wmin=0.0, wmax=1.2, wexp=0.7
;
; EXTERNAL
...
;               28 Oct 2015 Change default dexp from 0.7 to 0.6.
;-------------------------------------------------------------------------------
;-

PRO kcor_fvs, fits_list, cm=cm, wmin=wmin, wmax=wmax, wexp=wexp, gif=gif
;{
...
;  PAUSE
  END    ;}
   ...
   fitsdisp_kcor, fits_name, xdim_prev, ydim_prev, $
