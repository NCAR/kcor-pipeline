pro kcor_reduce_calibration_write_data, data, metadata, $
	...
	pixels0var = ncdf_vardef(cid, 'Pixels Fit with Model for Beam 0', [vectordim,pixels0dim], /short)
	fits0var = ncdf_vardef(cid, 'Model Fit Parameters for Beam 0', [paramsdim,pixels0dim], /float)
	fiterrors0var = ncdf_vardef(cid, 'Model Fit Parameters Formal Errors for Beam 0', [paramsdim,pixels0dim], /float)
	pixels1var = ncdf_vardef(cid, 'Pixels Fit with Model for Beam 1', [vectordim,pixels1dim], /short)
	fits1var = ncdf_vardef(cid, 'Model Fit Parameters for Beam 1', [paramsdim,pixels1dim], /float)
	fiterrors1var = ncdf_vardef(cid, 'Model Fit Parameters Formal Errors for Beam 1', [paramsdim,pixels1dim], /float)
	mmatvar = ncdf_vardef(cid, 'Modulation Matrix', [xdim, ydim, beamdim, stokesdim, statedim], /float)
	dmatvar = ncdf_vardef(cid, 'Demodulation Matrix', [xdim, ydim, beamdim, statedim, stokesdim], /float)
