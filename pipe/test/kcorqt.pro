...
; 27 Feb 2015 Timing version.  Use level0 for L0 fits files, qt for output gifs.
;-------------------------------------------------------------------------------
...
PRO kcorqt, date, list=list, append=append
...
l0_dir        = l0_base + date + '/level0/'		; L0 fits files.
q_dir         = l0_base + date + '/qt/'			; Quality directory.
