...
;  4 Mar 2015 Level 0 files are in 'level0' sub-directory.
;-------------------------------------------------------------------------------
...
PRO kcorq3, date, list=list, append=append
...
IF (np EQ 0) THEN $
BEGIN ;{
   PRINT, "kcorq3, 'yyyymmdd', list='list'"
   RETURN
END   ;}
...
raw_dir  = '/hao/mlsodata3/Data/KCor/raw/2014/'	; raw      directory.
date_dir = raw_dir + date  + '/'		; yyyymmdd directory
...
CD, date_dir				; Move to raw kcor directory.
...
PRINTF, ULOG, "kcorq3, '", date, "', list='", list, "'"
