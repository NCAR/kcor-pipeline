...
; 28 Jan 2015 [ALS] Modify L1SWID = 'kcorl1a.pro 28jan2015'.
...
;------------------------------------------------------------------------------
; SYNTAX :
; kcorl1a, date_string, list='list_of_L0_files', base_dir='base_directory_path'
; kcorl1a, 'yyyymmdd', list='L0_list', base_dir='/hao/mlsodata1/Data/KCor/raw'
; 
; EXAMPLES:
; kcorl1a, '20141101', list='list17'
; kcorl1a, '20140731', list='doy212.ls',base_dir='/hao/mlsodata1/Data/KCor/work'
;
...
pro kcorl1a, date_str, list=list, base_dir=base_dir
...
calfile = '20150402_183851_ALL_ANGLES_kcor_cal_1.0msec.ncdf'
...
;  IF (TYPE EQ 'science') THEN BEGIN
   ...
   sun, year, month, day, ehour, $
        sd=sd, pa=pa, lat0=lat0
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   ...
   ;----------------------------------------------------------------------------
   ; Display image, annotate, and save as a GIF file.
   ;----------------------------------------------------------------------------
...
;                        ' calibration file:dark, opal, 4 pol.states'
   sxaddpar, newheader, 'L1SWID',   'kcorl1a.pro 28jan2015', $
...
PRINT,        '>>>>>>> End of kcorl1a <<<<<<<'
PRINTF, ULOG, '>>>>>>> End of kcorl1a <<<<<<<'
