...
;------------------------------------------------------------------------------
; SYNTAX :
; kcorl1g, date_string, list='list_of_L0_files', base_dir='base_directory_path'
; kcorl1g, 'yyyymmdd', list='L0_list', base_dir='/hao/mlsodata1/Data/KCor/raw'
; 
; EXAMPLES:
...
;                        ' calibration file:dark, opal, 4 pol.states'
   sxaddpar, newheader, 'L1SWID',   'kcorl1g.pro 28jan2015', $
