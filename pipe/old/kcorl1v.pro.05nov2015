...
;------------------------------------------------------------------------------
; :Examples:
; kcorl1v, date_string, list='list_of_L0_files', $
;               base_dir='base_directory_path'
; kcorl1v, 'yyyymmdd', list='L0_list', $
;               base_dir='/hao/mlsodata3/Data/KCor/raw/2015/'
; kcorl1v, '20141101', list='list17'
; kcorl1v, '20141101', list='list17', /append
; kcorl1v, '20140731', list='doy212.ls',base_dir='/hao/mlsodata1/Data/KCor/work'
;
...
pro kcorl1v, date_str, list=list, $
...
;print,        '--- kcorl1v ', date_str, ' --- ', current_time
;print,        'l0_dir: ', l0_dir
;print,        'l1_dir: ', l1_dir

printf, ULOG, '--- kcorl1v ', date_str, ' --- ', current_time
...
;   fxaddpar, newheader, 'L1SWID',  'kcorl1v.pro 03nov2015', $
;                        ' Level 1 software'

   fxaddpar, newheader, 'DATE_DP', date_dp,    ' data processing date (UTC)'
   fxaddpar, newheader, 'DPSWID',  'kcorl1v.pro 05nov2015', $
...
;                        ' calibration file:dark, opal, 4 pol.states'
   ...
   fxaddpar, newheader, 'O1FOCS',   struct.o1focs, $
			...
			format = '(f8.3)'
   fxaddpar, newheader, 'RCAMFOCS', struct.rcamfocs, $
                        ' [mm] camera 0 focus position', format='(f9.4)'
   fxaddpar, newheader, 'TCAMFOCS', struct.tcamfocs, $
...
print,        '>>>>>>> End of kcorl1v <<<<<<<'
printf, ULOG, '>>>>>>> End of kcorl1v <<<<<<<'
printf, ULOG, '- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -'
