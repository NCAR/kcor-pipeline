;+
; :Author: Alice Lecinski 2013
;
; :Uses: Quick GBU determination for COSMO K-coronagraph images.
;-

see_data = 0		; whether or not to display the data processing steps
is_eng   = 0		; =1 Engineering data.
      ...
      if(scispot eq 24 ) then begin ;{ We've got science data! :-)
       ...
       ;print, cavg, ' cavg should be < ', cldlimit, ' to be cloud free'
        ...
        if ((cavg ge 1.) and ( cavg le cldlimit )) then begin ;{
                     ...
                     ;; Setting iimg = 2 will force skipping over
	    iimg = 2 ;; the find center and shifts.
           ...
           ;smlrpB0 = rpB0 (256:1023-256, 256:1023-256)
		    ...
		    _b = bytarr (256)
		    _c = bytarr (256)
                    readu, 11, _a  &  readu, 11, _b  &  readu, 11, _c
		    close, 11
                    tvlct, _a, _b, _c
                endif;}
