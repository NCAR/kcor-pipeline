...
$command = "CREATE TABLE kcor_cal_test
  ...
  calpol		CHAR (3),
  calpang		FLOAT (8, 3),
  mean_int_img0	FLOAT (9, 3),
  mean_int_img1	FLOAT (9, 3),
  mean_int_img2	FLOAT (9, 3),
  mean_int_img3	FLOAT (9, 3),
  mean_int_img4	FLOAT (9, 3),
  mean_int_img5	FLOAT (9, 3),
  mean_int_img6	FLOAT (9, 3),
  mean_int_img7	FLOAT (9, 3),
  rcamid		CHAR (18),
  tcamid		CHAR (18),
  rcamlut		CHAR (14),
  tcamlut		CHAR (14),
